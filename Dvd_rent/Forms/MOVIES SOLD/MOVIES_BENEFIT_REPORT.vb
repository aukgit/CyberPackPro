...
Public Class MOVIES_BENEFIT_REPORT
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MOVIES_BENEFIT_REPORT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMOVIES_BENEFIT_REPORT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MOVIES_BENEFIT_REPORT = New MOVIES_BENEFIT_REPORT
        rpt.Site = Me.Site
        Return rpt
    End Function
