...
ADDIN:              CUS_ID = CStr(CusR.Costomer_ID).ToString.ToUpper
    ...
    Public Sub CancelMember()
        ...
        Me.due_CheckAddNewMov.Checked = True
    End Sub
    ...
    'Private Sub ERROR_RESUME(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripMenuItem80.Click
    '    'For k As Integer = 0 To Me.Product_CollectionDataGridView.SelectedRows.Count - 1
    '    Dim Str1 As String
    '    Dim T As DataTable
    '    Str1 = ADSRC.ROWC_Get_In_InCommand_Grd(Me.Product_CollectionDataGridView, 0, 0, True, 7, "InHand") 'Only get names a,b,c as which place is "inHand" 
    '    SFC("a")
    '    STC(Str1)
    '    ExpreC("q")
    '    T = ADSRC.AdvSummSys_RTable(Me.AukDatabaseDataSet.DVDMainError, "DVD_ID,DVD_RENT_Costomer_ID", "", "", False)
    '    If T.Rows.Count > 0 Then
    '        For K As Integer = 0 To T.Rows.Count - 1
    '            Dim DID As String = T.Rows(K).Item(0)
    '            Dim Customer As String = T.Rows(K).Item(1)
    '            If ADSRC.FIND_FROM_DATATABLE_INDEX(Me.AukDatabaseDataSet.Product_Collection, DID) = True Then
    '                RowX.Item("Place") = "InStore"
