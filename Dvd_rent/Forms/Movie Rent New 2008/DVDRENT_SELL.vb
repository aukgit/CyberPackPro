    ...
    Public Function SEND_MOVIES_BY_DVDID(ByVal SENDER As Object, ByVal DVDID As String, Optional ByVal SendAs As String = "InHand", Optional ByVal iF_INHAND_FALSE_THEN_SEND As Boolean = True, Optional ByVal DUE As Boolean = False)
        ...
        If Rent = True Then
            If AukF.FindTxt(DVDID, ",") = True Then
                SFC("DVD_ID")
                STC(SrGens.ArrayToStr(Split(DVDID, ","), ",", "'", "'")) 'get str as 1,2,3='1','2','3'
            Else
                SFC("DVD_ID")
                STC(DVDID)
            End If
            AukF.Db_LoadN(DVD, -1, "PRODUCT_COLLECTION", False)
...
ADDIN:  CUS_ID = CStr(CusR.Costomer_ID).ToString.ToUpper
    ...
    Public Sub GetProduct_Be()
        ...
        Next
    End Sub
    Private Sub SavePro(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SaveProgramaticToolStripMenuItem.Click, ToolStripButton7.Click, SAVEPROGRAMMATICWAYToolStripMenuItem.Click, ToolStripMenuItem24.Click, ToolStripMenuItem58.Click
        Me.TRntC()
        If Rent = True Then
    ...
    Private Sub CostomerbrowseToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CostomerbrowseToolStripMenuItem.Click, ToolStripMenuItem4.Click, ToolStripMenuItem35.Click
        Me.TabControl1.SelectedIndex = 1
    ...
    Private Sub GetCurrentProductTotalBenefitToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GetCurrentProductTotalBenefitToolStripMenuItem.Click, ToolStripMenuItem37.Click
        Me.GetProduct_Be()
    ...
    Private Sub Todays_RentedMovies_ReportView(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TODAYSBEToolStripMenuItem.Click, TODAYSTOTALRENTALMOVIESSHOWToolStripMenuItem.Click
        ...
        If Me.AukDatabaseDataSet.DVD_PROFIT.Count > 0 Then
            ...
            AukF.Prnt(M, Me.AukDatabaseDataSet, Nothing)
        Else
    ...
    Private Sub ToolStripButton28_ButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub Costomers_nameLabel_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Costomers_nameLabel.KeyDown
        If e.KeyCode = Keys.Enter Then
            If e.Control = True Then 'MAKE THEM DUE
                A = sender.TEXT
                If AukF.FindTxt(A, ",") = True Then
                    Dim uA As Array
                    uA = Split(A, ",")
                    For K As Integer = 0 To uA.GetUpperBound(0)
                        M = ArV(uA, K)
                        Me.SEND_MOVIES_BY_DVDID(sender, M, "InHand", True, True)
                    Next
                Else
                    Me.SEND_MOVIES_BY_DVDID(sender, sender.TEXT, "InHand", True, True)
                End If
            Else
                A = sender.TEXT
                If AukF.FindTxt(A, ",") = True Then
                    ...
                    For K As Integer = 0 To uA.GetUpperBound(0)
                        M = ArV(uA, K)
                        Me.SEND_MOVIES_BY_DVDID(sender, M)
                    Next
                Else
                    Me.SEND_MOVIES_BY_DVDID(sender, sender.TEXT)
                End If
    ...
    Private Sub DUE_CLICLbUT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DUE_CLICLbUT.Click, DUE_PAIDCLICK.Click
    ...
    Private Sub Rent_InformationLoad_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles ToolStripTextBox9.KeyDown, ToolStripTextBox8.KeyDown, ToolStripTextBox10.KeyDown
        ...
        CSOFT.Events_of_SummaryTextBox_KeyDown(Me, sender, e, Me.AukDatabaseDataSet.DVD_Rent, "Date_rent")
    End Sub
