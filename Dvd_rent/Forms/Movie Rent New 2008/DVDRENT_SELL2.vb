    ...
    Public Function SEND_MOVIES_BY_DVDID(ByVal SENDER As Object, ByVal DVDID As String, Optional ByVal SendAs As String = "InHand", Optional ByVal iF_INHAND_FALSE_THEN_SEND As Boolean = True, Optional ByVal DUE As Boolean = False)
        ...
        If Rent = True Then
            ...
            If Me.DVD_RentBindingSource.Count > MaxCan Then
                ...
                MsgBox("Sorry,he/she can't rent more dvd/cd than that.", MsgBoxStyle.Exclamation)
                Exit Function
            End If
...
ADDIN:              CUS_ID = CStr(CusR.Costomer_ID).ToString.ToUpper
    ...
    Public Sub TRntC()
        ...
        If Me.AukDatabaseDataSet.DVD_Rent.Count > 0 Then
            ...
            ',new due
            'If Me.AukDatabaseDataSet.DVD_Rent.GetChanges(DataRowState.Added) Is Not Nothing Then
            '    DueDec = Val(Me.AukDatabaseDataSet.DVD_Rent.GetChanges(DataRowState.Added).Compute("Sum([Pay_money])", "Due=True"))
            'Else
            '    DueDec = 0
            'End If
            'If DueDec > 0 Then
            '    Dstr2 = " ,NewRent Due: " & DueDec
            'End If
            If Me.AukDatabaseDataSet.DVD_Rent.GetChanges(DataRowState.Added).Rows IsNot Nothing Then
                ...
                If NewAdd > 0 Then 'new ,movies add money
                    NStr = " ,NewRent Cost: " & NewAdd & Dstr2
                Else
                    NStr = ""
                End If
            Else
