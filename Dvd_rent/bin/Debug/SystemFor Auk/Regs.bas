...
Public hKey As Long, MainKeyHandle As Long
Public rtn As Long, lBuffer As Long, sBuffer As String
Public lBufferSize As Long
Public lDataSize As Long
...
Public Function SetDWORDValue(SubKey As String, Entry As String, Value As Long)
...
End Function
Public Function GetDWORDValue(SubKey As String, Entry As String)
...
End Function
Public Function SetBinaryValue(SubKey As String, Entry As String, Value As String)
...
Public Function GetBinaryValue(SubKey As String, Entry As String)
...
End Function
 Public Function DeleteKey(Keyname As String)
...
End Sub
Public Function CreateKey(SubKey As String)
