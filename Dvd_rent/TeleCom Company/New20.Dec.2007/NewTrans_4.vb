...
nextwork: Me.Mob_ComTableAdapter.Fill(Me.AukDatabaseDataSet.Mob_Com)
    ...
    Public Sub Extent_Fields_readOnly()
        ...
        Me.D_Discount_Field.ReadOnly = True
...
DOWORKD:
    ...
    Public Sub RECHARGE_NUMBER(Optional ByVal S As String = "SEND")
        ...
        If STR1 = "" Then
            ...
            Else '=due
                MINUS_BLANCE()
                Drv(11, DRow).Value = 0 'benefit field
                'GoTo BENEFIT_WORK
            End If
        ...
        ElseIf STR1 = "SEND" Or STR1 = "SEND BUT NOT PAID YET" Then
            If S = "UNSEND" Then
                PLUS_BLANCE() 'adding in account beacuse of unsend
                Drv(10, DRow).Value = DBNull.Value  'MAKE SEND TIME="",UNSEND
            ...
            ElseIf S = "SEND" Then
                'next benefit work
                GoTo BENEFIT_WORK  'GoTo BENEFIT_WORK
            End If
        End If
        BLANCE()
...
due_Loss_Chek:
        ...
        BLANCE()
trans_CurBalx:
        If S = "UNSEND" Then Drv(6, DRow).Value = 0 : Exit Sub
    ...
    Private Sub New_TransDataGridView_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles New_TransDataGridView.KeyDown
        BLANCE()
        'If e.KeyCode = Keys.F3 Or e.KeyCode = Keys.F5 Or e.KeyCode = Keys.F6 Or e.KeyCode = Keys.F7 Then
        '    Me.New_TransDataGridView.EndEdit()
        'End If
...
DOWORKD:
    ...
    Private Sub CARD_SELL(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CARD_CEEL1.Click
    ...
    Private Sub SENDMESSAGETIMEToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SENDMESSAGETIMEToolStripMenuItem.Click
        MsgBox(Me.CID_GET() & "CURRENT NUMBER : " & Me.CELL_NUMB_GET & vbCrLf & "SEND TIME:" & AukF.GridT(Me.New_TransDataGridView, 10).ToString, MsgBoxStyle.Information, "SEND TIME")
    End Sub
    ...
    Private Sub REMOVESPACEANDFROMCELLNUMBERSToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles REMOVESPACEANDFROMCELLNUMBERSToolStripMenuItem.Click
        SoftIn.SELECTED_CELLS_Replace_MultiTexts(Me.New_TransDataGridView, "2,2", "-, ", "", "", True)
    End Sub
