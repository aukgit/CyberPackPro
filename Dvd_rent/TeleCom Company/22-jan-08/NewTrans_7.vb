Public Class NewTrans
    ...
    Public Sub SAVE_MOBS()
        ...
        Catch ex As Exception
            'If Err.Description <> "Operation is not valid because it results in a reentrant call to the SetCurrentCellAddressCore function." Then
            If Err.Description <> "Column 'ID' does not allow nulls." Then
                Epx()
                'Else
                '    MsgBox("Please don't do this again.", MsgBoxStyle.Information)
            End If
        End Try
    End Sub
...
closeafter:
        ...
        If e.ColumnIndex = 9 OrElse e.ColumnIndex = 4 OrElse e.ColumnIndex = 6 Then 'eFFECT ON CURRENT BENEFT AFTER EDIT DISCOUNT
...
DOWORKD:
        ...
        ExpreC("*l", "l*")
        BracketsSql = False
        aBSql = SoftIn.Replace_MultiTexts(AukSql.AukSql_Main().ToString, "(,)", ",")
        'MsgBox(BSql)
        SFC("", "", "STATUS")
...
lastend:    MsgBox("Information of Cards is not found in this Records.", MsgBoxStyle.Information)
    ...
    Private Sub Execute_Date_ButtonEffect(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OpenOnlyDueByCellNumberToolStripMenuItem.Click, OpenOnlyDueByDateToolStripMenuItem.Click, OpenByDateToolStripMenuItem.Click, OpenByCellNumberToolStripMenuItem1.Click
        a = sender.text
...
DOWORKD:
            Try
                ...
                SnX("=")
                AukF.Db_LoadN(Me.AukDatabaseDataSet.New_Trans, -1, "", True)
                SFC("Date_Business", "STATUS", "dUE_cARDS")
                STC(CDate(sender.text), CSold, "tRUE")
                DTC("d", "", "B")
                SnX("=")
                AukF.Db_LoadN(Me.AukDatabaseDataSet.New_Trans, -1, "", False)
            Catch ex As Exception
    ...
    Private Sub FrmKeydown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Enter Then
