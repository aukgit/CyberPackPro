...
Public Class MobileReportCardsOnly2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MobileReportCardsOnly2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMobileReportCardsOnly2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MobileReportCardsOnly2 = New MobileReportCardsOnly2
        rpt.Site = Me.Site
        Return rpt
    End Function
