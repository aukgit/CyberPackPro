Public Module SoftIn
    ...
    Public Sub KeyDown_EffectOn_Combo(ByVal Com As Object, ByVal e As KeyEventArgs)
        ...
        End If
    End Sub
    Public Sub DataGridView_AutoMaticID(ByVal D As DataGridView, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs, Optional ByVal ToKen As String = Nothing)
            ...
            Else
                If D(0, e.RowIndex - 1).Value.ToString <> "" Then
                    ...
                    Else
                        ...
                        D(0, e.RowIndex).Value = NB1.Split(My.Settings.DVDID_TOKEN.ToString).GetValue(0).ToString & ToKen & Val(NA1) + 1
                    End If
                End If
            End If
        End If
    ...
    '    'End If
    'End Sub
    Public Function Dat2(ByVal D As String) As Date
        Dim c As Date
        Try

            c = CDate(D)
            If c.Day <= 12 Then
                c = Format(c, "MMM/dd/yyyy")
    ...
    Public Sub Master_ID_String(ByVal D As DataGridView, Optional ByVal maxLen As Integer = 9, Optional ByVal MCol As Integer = 0)
        ...
        If AukF.GridT(D, MCol) = "" Then
            ...
            'MsgBox(agb)
            If DRow > -1 Then D(MCol, DRow).Value = UCase(Left(SoftIn.Convert_Hash_RND1(agb), maxLen))
        End If
    End Sub
    Public Function Master_ID_NumberInsert_NonAuto(ByVal D As DataGridView, ByVal Number As Decimal, Optional ByVal MCol As Integer = 0)
...
gotoN:      For K As Integer = 0 To D.SelectedRows.Count - 1
                ...
                If Dont_RrpArrStr <> "" Then
                    ...
                    If AukF.FindTxt(a, Dont_RrpArrStr, Match) = True Then
                        GoTo gotoN
                    End If
                End If
                If Match = False Then
    ...
    Public Sub SELECTED_CELLS_Replace_MultiTexts(ByVal D As DataGridView, ByVal ColumnsArrarY As String, ByVal FindArray As String, ByVal RepArray As String, Optional ByVal MatchsArraY As String = "", Optional ByVal USeAllRows As Boolean = False, Optional ByVal Dont_ReplaceArrayStr As String = "", Optional ByVal Key As String = ",")
        ...
        If Col IsNot Nothing And Fnd IsNot Nothing Then
            For K As Integer = 0 To Col.GetUpperBound(0)
                ...
                End If
                SELECTED_CELLS_Replace_text_By_Column(D, CInt(Colx), Fndx, Repx, CBool(Matx), USeAllRows)

            Next
        End If
    End Sub
    Public Sub Replace_MultiTexts(ByVal Text As String, ByVal FindArray As String, ByVal RepArray As String, Optional ByVal MatchsArraY As String = "", Optional ByVal Key As String = ",")
        If Trim(ColumnsArrarY) = "" Then Exit Sub
    ...
    Public Function DataGrid_MasterID_ByDate(ByVal D As DataGridView, Optional ByVal MColumn As Integer = 0, Optional ByVal AMCon As String = "1", Optional ByVal PmCon As String = "2", Optional ByVal ReplaceFinderArray As Array = Nothing, Optional ByVal ReplaceTextArray As Array = Nothing, Optional ByVal MasterColumnVisibleFalse As Boolean = True, Optional ByVal IfMainColumnNotNullNotGen As Boolean = False)
        ...
        Try
            If AukF.GridT(D, MColumn) = "" Then
                If DRow > -1 Then D(MColumn, DRow).Value = Cstr1
            End If
        Catch ex As Exception
            Epx()
        End Try
