Public Module SoftIn
    ...
    Public Function OleDB_DataSource_Cnn(ByVal DBSource As String, Optional ByVal Password As String = Nothing)
        ...
        contEr = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=AukDsOurce!%;Persist Security Info=True;Jet OLEDB:Database Password=&*())_#!%$^&PasSwXqor!@3##d"
        Ua = contEr.Split(";")
        If Password IsNot Nothing Then
            Count = Ua.GetUpperBound(0)
        Else
            Count = Ua.GetUpperBound(0) - 1
        End If
        DSource = ""
        For k As Integer = 0 To Count
            If k = 1 Then
                Ua.SetValue(Ua.GetValue(1).ToString.Replace("AukDsOurce!%", DBSource), 1)
            ElseIf k = 3 Then
                Ua.SetValue(Ua.GetValue(3).ToString.Replace("&*())_#!%$^&PasSwXqor!@3##d", Password), 3)
            End If
            m = Ua.GetValue(k).ToString & ";"
            DSource = DSource & m

        Next
        'MsgBox(DSource)
        OleDB_DataSource_Cnn = DSource
    End Function
    ...
    Public Function Convert_Hash_RND2(ByVal Str1 As String, Optional ByVal NumPlus As Integer = 0, Optional ByVal NumInto As Integer = 0, Optional ByVal Gethash_ByMadeIT_Double As Boolean = False, Optional ByVal maxD As Integer = 22, Optional ByVal GetCodeByCode As Boolean = False) As String
        ...
        End If
    End Function
    Public Function Serial_D_S_Cells(ByVal D As DataGridView)
        For k As Integer = 0 To D.SelectedCells.Count - 1
            Iw = k + 1
            D.SelectedCells(k).Value = Iw
        Next
    End Function
    Public Function Master_ID_String(ByVal D As DataGridView, Optional ByVal maxLen As Integer = 9, Optional ByVal MCol As Integer = 0, Optional ByVal Text1 As String = "Auksoftware's")
        ...
        End If
    End Function
    Public Function Master_ID_NumberInsert(ByVal D As DataGridView, ByVal Number As Decimal, Optional ByVal MCol As Integer = 0)
        'n = D.Name.ToString : l = D.Columns(MCol).DataPropertyName.ToString
        's = Now.Date & Now.Second : b = Now.Millisecond + Now.Second
        'agb = n & s & b & Text1 & My.Application.Info.ProductName.ToUpper & l
        If AukF.GridT(D, MCol) = "" Then
            D(MCol, DRow).Value = Number
        End If
    End Function
    Public Function Rows_Select(ByVal T As DataTable, ByVal Column As Object, ByVal FindStr As String) As DataRow()
        ...
        Return R
    End Function
    Public Function Master_ID_String_Get(Optional ByVal maxLen As Integer = 9, Optional ByVal MCol As Integer = 0, Optional ByVal Text1 As String = "Auksoftware's")
        s = Now.Date & Now.Second : b = Now.Millisecond + Now.Second
        agb = Now.Day & s & b & Text1 & My.Application.Info.ProductName.ToUpper & l
    ...
    Public Function Master_ID_Row_String(ByVal R As DataRow, Optional ByVal Entry_if_exist As Boolean = False, Optional ByVal maxLen As Integer = 9, Optional ByVal MCol As Integer = 0, Optional ByVal Text1 As String = "Auksoftware's")
        ...
        End If
    End Function
    Public Function SELECTED_CELLS_COMMON_TXT(ByVal D As DataGridView, ByVal STR As String)
        For K As Integer = 0 To D.SelectedCells.Count - 1
...
b:      Iw += 1 : Resume Next
    ...
    Public Function Same_Input(ByVal Row As DataRow, Optional ByVal MColumn As Integer = 0, Optional ByVal MasterIds As String = "", Optional ByVal Columns As String = "", Optional ByVal Changes As String = "", Optional ByVal Input_MasterId As Boolean = False, Optional ByVal UseMaster_Before As Boolean = False, Optional ByVal Key As String = ",")
        ...
        If Columns.Trim <> "" Then
            CAr = Columns.Split(Key)
        End If
        If Changes.Trim <> "" Then
            ChArs = Changes.Split(Key)
        End If
        'UseMaster_Before
        For K As Integer = 0 To MIds.GetUpperBound(0)
            Rn = T.NewRow
            Midx = ArV(MIds, K)
            Rn(M) = Midx
            If Input_MasterId = True Then
    ...
    Public Function Normal_Format(ByVal Db1 As DataTable, ByVal Title As Object, ByVal Fstr As String, Optional ByVal Sign As String = "=", Optional ByVal Fr1 As String = "'", Optional ByVal Fr2 As String = "'", Optional ByVal LikeTr As Boolean = False)
        ...
        Else
            ...
            Else
                ...
                ElseIf WGeT = "Boolean" Then
                    If Fstr.ToLower = "y" Or Fstr.ToLower = "yes" Or Fstr.ToLower = "c" Or Fstr.ToLower = "check" Or Fstr.ToLower = "checked" Or Fstr.ToLower = "1" Then
                        Fstr = "TRUE"
                    Else
                        Fstr = "FALSE"
                    End If
        ...
        WGeT = Normal_Format
    End Function
    Public Function GetFunction_QrText(ByVal Db1 As DataTable, ByVal Title As Object, ByVal Fstr As String, Optional ByVal Func As Integer = 0, Optional ByVal Sign As String = "=", Optional ByVal ChecksAutoMaticNumer As Boolean = False, Optional ByVal ComplexKey As String = ",", Optional ByVal SWildCard As String = "%")
    ...
    Public Function DataGrid_MasterID_ByDate(ByVal D As DataGrid, Optional ByVal MColumn As Integer = 0, Optional ByVal AMCon As String = "1", Optional ByVal PmCon As String = "2", Optional ByVal ReplaceFinderArray As Array = Nothing, Optional ByVal ReplaceTextArray As Array = Nothing, Optional ByVal MasterColumnVisibleFalse As Boolean = True)
        ...
        End Try
    End Function
    Public Function DataGrid_MasterID_ByDate(ByVal D As DataGridView, Optional ByVal MColumn As Integer = 0, Optional ByVal AMCon As String = "1", Optional ByVal PmCon As String = "2", Optional ByVal ReplaceFinderArray As Array = Nothing, Optional ByVal ReplaceTextArray As Array = Nothing, Optional ByVal MasterColumnVisibleFalse As Boolean = True, Optional ByVal IfMainColumnNotNullNotGen As Boolean = False)
    ...
    Public Function TxtColor(ByVal Obj As Object, ByVal FndTxt As String, ByVal BckColor As Color, ByVal ForColor As Color, ByVal DefBColor As Color, ByVal DefForColor As Color, Optional ByVal FullMatch As Boolean = True)
        ...
        End If
    End Function
    Public Function MASTER_ID_GET(ByVal D As DataGridView, Optional ByVal MColumn As Integer = 0, Optional ByVal MaxLen As Integer = 4) As Integer
...
comid:  m = Now.Millisecond : s = Now.Second : mn = Now.Minute
    ...
    Public Function Previous_data_input(ByVal Bp As BindingSource, ByVal T As DataTable, Optional ByVal COLUMN As Integer = -1)
        ...
        End If
    End Function
    Public Function TOOLSTRIP_COMBO_DATASOURCE(ByVal COM As Object, ByVal T As Object, ByVal BIND_C As Integer, Optional ByVal CLEARBEFORE As Boolean = True, Optional ByVal UNIQUE As Boolean = False)
        Dim T1 As DataTable = AukF.Get_DataSystemObj(T)
    ...
    Public Function ChgColr(ByVal Obj As Object, ByVal BColor As Color, ByVal FColor As Color)
        ...
        End Try
    End Function
    Public Function AddToLstObj_DataTypes_Add(ByVal Lst As Object, ByVal D As DataGridView, Optional ByVal Separete As String = "")
