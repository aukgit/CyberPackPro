Public Class Option_Gen
    ...
    Private Sub Advance_FeesLabel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub ChgText1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox12.TextChanged, TextBox11.TextChanged
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        'D = InputBox("PLEASE TYPE A DRIVE NAME WHERE YOU WANT TO BACKUP.", "DATABASE BACKUP", D)
        'My.Application.SaveMySettingsOnExit = True
        'Try
        '    My.Computer.FileSystem.CopyFile(Register.Dbname.ToString, My.Computer.FileSystem.SpecialDirectories.Desktop.ToString() & "\AukDatabase2.mdb")
        '    MsgBox("DATABASE BACKUP ON DESKTOP.", MsgBoxStyle.Information)
    ...
    Private Sub CYBERCAFEANDBUSINESSSETTINGSToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
