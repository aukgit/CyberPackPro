...
Public Class PS_MEMO_RP24_SDiscount
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PS_MEMO_RP24_SDiscount.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPS_MEMO_RP24_SDiscount
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PS_MEMO_RP24_SDiscount = New PS_MEMO_RP24_SDiscount
        rpt.Site = Me.Site
        Return rpt
    End Function
