Public Class PS_SOLD
    ...
    Public Sub SELL()
        If GS = True Then
            ...
            If Me.AukDatabaseDataSet.RP_ID.Rows.Count = 0 Then
                Me.RP_IDTableAdapter.Insert(RpID, 0, 0, 0, 0, "CASH", SoftIn.Default_DataTable(Me.AukDatabaseDataSet.PS_Employe), CDate(Now.Date))
                SFC("REPORT_ID")
                STC(RpID)
                AukF.Db_LoadN(Me.RP_IDBindingSource)
    ...
    Private Sub SEARCHQUERYToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SEARCHQUERYToolStripMenuItem.Click
        ...
        'FrmL(AukQ)
        DVDRENT.ShowQr_Product(AukQ, Me.DataGridView1, Me.PSSOLDBindingSource, "([DISPLAY_ID]  <>'" & "MOVIESOLD" & "')")
    End Sub
        ...
        If WARCHK.Rows.Count = 1 Then
            ...
            If (Val(mONTHS) - Val(V)) > 0 Then
                ...
                Else
                    ...
                    Me.PS_WARRANTYTableAdapter1.Insert(ID, RowX(0), PRO_SR, CDate(Now.Date), CInt(REMAIN), DqA, RowX("REPORT_ID").ToString)
